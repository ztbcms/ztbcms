...
CREATE TABLE `cms_downloader`  (
   ...
   `file_thumb` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '文件缩略图',
   `downloader_implement_num` int(11) UNSIGNED NULL DEFAULT 0 COMMENT '下载执行次数',
   `downloader_next_implement_time` int(11) UNSIGNED NULL DEFAULT 0 COMMENT '下一次执行的时间',
   `create_time` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '上传时间',
