                ...
                <template>
                    <div>
                        <el-form ref="elForm" :model="formData" :rules="rules" size="medium" label-width="180px">
                            ...
                            <!--七牛云-->
                            <template v-if="formData.attachment_driver == 'Qiniu'">
                                <el-form-item label="qiniu-AccessKey">
                                    <el-input v-model="formData.attachment_qiniu_access_key"
                                        placeholder="请输入七牛云AccessKey"></el-input>
                                </el-form-item>
                                <el-form-item label="qiniu-SecretKey">
                                    <el-input v-model="formData.attachment_qiniu_secret_key"
                                        placeholder="请输入七牛云SecretKey"></el-input>
                                </el-form-item>
                                <el-form-item label="qiniu-Bucket">
                                    <el-input v-model="formData.attachment_qiniu_bucket"
                                        placeholder="请输入存储空间名称"></el-input>
                                </el-form-item>
                                <el-form-item label="qiniu-CDN域名">
                                    <el-input v-model="formData.attachment_qiniu_domain"
                                        placeholder="请输入CDN加速域名，如 https://cdn.example.com"></el-input>
                                </el-form-item>
                                <el-form-item label="qiniu-读写权限">
                                    <el-radio v-model="formData.attachment_qiniu_privilege" label="1">公共读</el-radio>
                                    <el-radio v-model="formData.attachment_qiniu_privilege" label="2">私有</el-radio>
                                </el-form-item>
                                <el-form-item v-if="formData.attachment_qiniu_privilege==2" label="qiniu-临时访问链接过期时间">
                                    <el-input type="number" v-model="formData.attachment_qiniu_expire_time"
                                        placeholder="请输入临时链接过期时间">
                                        <template slot="append">秒</template>
                                    </el-input>
                                </el-form-item>
                            ...
                            <el-form-item label="直传文件路径模板" prop="attachment_direct_file_dir_template">
                                <el-input v-model="formData.attachment_direct_file_dir_template" placeholder="请输入直传文件路径模板" clearable
                                    :style="{width: '100%'}">
                                    <template slot="append">默认：{module}/{Y}/{m}/{d}/</template>
                                </el-input>
                                <div>
                                    <small>支持占位符：{module}、{Y}、{m}、{d}。示例：{module}/{Y}{m}{d}/</small>
                                </div>
                            </el-form-item>
                            <template v-if="formData.attachment_driver == 'Local'">
