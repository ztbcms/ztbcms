                                        ...
                                        <template v-for="(item, index) in galleryGroupList">
                                            <li :key="index" class="el-menu-item"
                                                ...
                                                <span @click="selectGroup(item.group_id)"
                                                      style="word-break:break-all; white-space:normal; width:75%;line-height: 20px;vertical-align:middle;display:inline-block;">
                                                    {{item.group_name}}
                                                </span>
                                ...
                                <div>
                                    ...
                                    <div>
                                        ...
                                        <el-select v-show="selectdFileList.length > 0" v-model="move_group_id"
                                            ...
                                            <el-option v-for="(item, index) in galleryGroupList"
                                                       :key="index"
...
<style>
    ...
    .select-file .el-menu-item:focus {
        outline: none;
        background-color: #ecf5ff;
    }

    .select-file .group_close {
        font-size: 15px;
        line-height: 30px;
    }

    .select-file .group_edit_icon {
        font-size: 15px;
        line-height: 30px;
    }
    ...
    .select-file .el-menu-item i {
        color: #303133;
        opacity: 0;
    }

    .select-file .el-menu-item:hover i {
        opacity: 0.9;
    }
