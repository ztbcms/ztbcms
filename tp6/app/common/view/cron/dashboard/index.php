        ...
        <el-form style="width: 800px" ref="form" label-width="140px">
            ...
            <el-form-item label="启用状态">
                ...
                <template v-else>
                    ...
                    <el-button type="success" size="mini" @click="toSetCronEnable(1)">启用</el-button>
                </template>
            ...
            <el-form-item label="命令方式启动">
                <p style="margin: 0;font-size: 12px;color: grey">建议以命令行模式运行</p>
                <p style="margin: 0;font-size: 12px;color: grey">1）启动计划任务调度 ： php think cron:run --progress 1</p>
                <p style="margin: 0;font-size: 12px;color: grey">2）执行指定任务 ： php think cron:exec --id 1   (执行ID为1的任务)</p>
                <p style="margin: 0;font-size: 12px;color: grey">3）执行指定任务 ： php think cron:exec --class "app\common\cronscript\DeleteCronLogScript"</p>
                <p style="margin: 0;font-size: 12px;color: grey">4）计划任务清理 ： php think cron:clean</p>
            </el-form-item>
