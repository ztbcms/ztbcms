...
class ImageProcess extends AdminController
{
    ...
    {
        $this->SITE_PATH = Config::get('demo.site_path');
    ...
    public function createSharePoster()
    {
        ...
        return json($this->_genImage($config));
    }
    ...
    private function _genImage($config)
    {
        // 图片命名规则
        $upload_dir = 'd/file/';
        $file_base_path = $this->SITE_PATH . $upload_dir;
        $poster_file_name = '';
        ...
        // 背景图
        $bg_img_url = $this->SITE_PATH . 'statics/admin/demo/elementui/images/bg.png';
        ...
        //用户头像
        $avatar_url = $this->SITE_PATH . 'statics/admin/demo/elementui/images/avatar.jpg';
        $w = 100;
        $h = 100;
        ...
        // 用户小程序二维码
        $mini_code_url = $this->SITE_PATH . 'statics/admin/demo/elementui/images/qrcode.png';
    ...
    {
        //引入字体
        $font_path = $this->SITE_PATH . 'statics/admin/demo/elementui/font/SourceHanSansCN-Regular.otf';
        //单行最大数量
