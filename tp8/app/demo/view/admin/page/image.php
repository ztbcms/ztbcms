                ...
                <div class="grid-content ">
                    <el-form ref="form" :model="form" label-width="80px">
                        <el-form-item label="相册">
                            <el-image v-for="url in preview_images" :key="url" :src="url" lazy
                                      style="width: 80px;margin-right:4px" :preview-src-list="[url]"></el-image>
                        </el-form-item>
...
<block name="footer">
    <!--  引入viewer.js  -->
    <script src="/statics/admin/viewerjs/viewer.min.js"></script>
    <link rel="stylesheet" href="/statics/admin/viewerjs/viewer.min.css">
    <!--  引入viewer.js  END -->
