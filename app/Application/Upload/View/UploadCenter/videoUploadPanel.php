                    ...
                    <el-col :span="18">
                        ...
                        <div class="grid-content bg-purple-light" style="margin-top: 10px;">
                            <div>
                                ...
                                <div>
                                    <el-button v-show="selectdVideoList.length > 0" type="danger" size="small"
                                               @click="clickDeleteSelected">删除选中
                                    </el-button>
                                    <el-button v-show="selectdVideoList.length > 0" type="primary" size="small"
                                               @click="clickCancelSelected">取消选中
                                    </el-button>
                                    <el-select v-show="selectdVideoList.length > 0" v-model="move_group_id"
    ...
    <script>
        $(document).ready(function () {
            new Vue({
                ...
                data: {
                    uploadConfig: {
                        uploadUrl: "{:U('Upload/UploadAdminApi/uploadVideo')}",
                        max_upload: 9,//同时上传文件数
                        accept: 'video/*', //接收的文件类型，请看：https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input#attr-accept
                    },
                    pagination: {
                        page: 1,
                        limit: 15,
                ...
                methods: {
                    ...
                    getGalleryByGroupIdList: function () {
                        ...
                        $.ajax({
                            url: "{:U('Upload/UploadAdminApi/getVideosByGroupIdList')}",
                            data: where,
                            dataType: 'json',
                            type: 'post',
                            success: function (res) {
                    ...
                    moveGroup: function () {
                        ...
                        for (var i = 0; i < this.selectdVideoList.length; i++) {
                            form['files'].push(this.selectdVideoList[i])
                        }
