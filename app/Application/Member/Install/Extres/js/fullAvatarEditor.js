function fullAvatarEditor() {
	...
	var file			= GV.DIMAUB+'statics/extres/member/js/fullAvatarEditor.swf';		//flash文件的路径
	var	version			= "10.1.0";						//播放该flash所需的最低版本
	var	expressInstall	= GV.DIMAUB+'statics/extres/member/js/expressInstall.swf';			//expressInstall.swf的路径
