...
class ShareController extends MemberbaseController {
    ...
    public function index() {
        ...
        $page = $this->page($count, 10, I('page', 1));
    ...
    public function add() {
        ...
        if (IS_POST) {
            ...
            $catidPrv = $CategoryPriv->where(array(
                "catid" => $catid,
                "roleid" => $this->userinfo['groupid'],
                "is_admin" => 0,
                "action" => "add"
            ))->find();
            if (empty($catidPrv)) {
    ...
    public function edit() {
        ...
        if (IS_POST) {
            ...
            $data = $ContentModel->relation(true)->where(array(
                "id" => $info['content_id'],
