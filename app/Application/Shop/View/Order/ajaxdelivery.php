                                ...
                                <volist name="orderList" id="list">
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="{:U('Shop/Order/delivery_info',array('order_id'=>$list['order_id']))}" data-toggle="tooltip" title="" class="btn btn-info" data-original-title="查看详情">去发货</a>
                                        	<else/>
                                        		<a href="{:U('Shop/Order/delivery_info',array('order_id'=>$list['order_id']))}" data-toggle="tooltip" title="" class="btn btn-info" data-original-title="查看详情"><i class="fa fa-eye"></i></a>
