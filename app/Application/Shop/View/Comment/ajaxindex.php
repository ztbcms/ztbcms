        ...
        <volist name="comment_list" id="list">
            <tr>
                ...
                <td class="text-center">
                    ...
                    <a href="javascript:void(0);" data-href="{:U('Shop/Comment/del',array('id'=>$list[comment_id]))}" onclick="del('{$list[comment_id]}',this)" id="button-delete6" data-toggle="tooltip" title="" class="btn btn-danger" data-original-title="删除"><i class="fa fa-trash-o"></i></a>
                </td>
            </tr>
        </volist>
