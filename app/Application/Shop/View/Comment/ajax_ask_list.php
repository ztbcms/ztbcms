      ...
      <td class="text-center">
        ...
        <volist name="comment_list" id="list">
            <tr>
                ...
                <td class="text-center">
                    <img width="20" height="20" src="{$config_siteurl}statics/extres/shop/images/<if condition='$list[is_show] eq 1'>yes.png<else />cancel.png</if>" onclick="changeTableVal('goods_consult','id','{$list.id}','is_show',this)"/>
                </td>
