        ...
        <table class="table table-bordered table-hover">
            ...
            <volist name="specList" id="list">
                <tr>
                    ...
                    <td class="text-left">{$goodsTypeList[$list[type_id]][name]}</td>                    
                    ...
                    <td class="text-right">                       
                        <a href="{:U('Spec/addEditSpec',array('id'=>$list['id']))}" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="编辑"><i class="fa fa-pencil"></i></a>
                        <a href="javascript:del_fun('{:U('Spec/delGoodsSpec',array('id'=>$list['id']))}');" id="button-delete6" data-toggle="tooltip" title="" class="btn btn-danger" data-original-title="删除"><i class="fa fa-trash-o"></i></a></td>
                </tr>
            </volist>
            </tbody>
        </table>
