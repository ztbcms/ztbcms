                            ...
                            <el-form-item label="JPEG 水印质量" prop="watermarkquality">
                                <div class="locate">
                                    <ul class="cc" id="J_locate_list">
                                        <li class="<if condition=" $Site[
                                        'watermarkpos'] eq '1' "> current</if>"><a href="" data-value="1">左上</a></li>
                                        <li class="<if condition=" $Site[
                                        'watermarkpos'] eq '2' "> current</if>"><a href="" data-value="2">中上</a></li>
                                        <li class="<if condition=" $Site[
                                        'watermarkpos'] eq '3' "> current</if>"><a href="" data-value="3">右上</a></li>
                                        <li class="<if condition=" $Site[
                                        'watermarkpos'] eq '4' "> current</if>"><a href="" data-value="4">左中</a></li>
                                        <li class="<if condition=" $Site[
                                        'watermarkpos'] eq '5' "> current</if>"><a href="" data-value="5">中心</a></li>
                                        <li class="<if condition=" $Site[
                                        'watermarkpos'] eq '6' "> current</if>"><a href="" data-value="6">右中</a></li>
                                        <li class="<if condition=" $Site[
                                        'watermarkpos'] eq '7' "> current</if>"><a href="" data-value="7">左下</a></li>
                                        <li class="<if condition=" $Site[
                                        'watermarkpos'] eq '8' "> current</if>"><a href="" data-value="8">中下</a></li>
                                        <li class="<if condition=" $Site[
                                        'watermarkpos'] eq '9' "> current</if>"><a href="" data-value="9">右下</a></li>
                                    </ul>
                                    <input v-model="formData.watermarkpos" id="J_locate_input" name="watermarkpos"
                                           type="hidden" value="{$Site.watermarkpos}">
                                </div>
                            </el-form-item>
                ...
                data() {
                    return {
                        formData: {
                            ...
                            attachment_aliyun_key_id: "{$Site.attachment_aliyun_key_id}",
                            attachment_aliyun_key_secret: "{$Site.attachment_aliyun_key_secret}",
                            attachment_aliyun_endpoint: "{$Site.attachment_aliyun_endpoint}",
                            attachment_aliyun_bucket: "{$Site.attachment_aliyun_bucket}",
                            attachment_aliyun_domain: "{$Site.attachment_aliyun_domain}",
