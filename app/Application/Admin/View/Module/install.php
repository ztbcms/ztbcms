    ...
    <form class="J_ajaxForm" action="{:U('Module/install')}" method="post">
        <div class="table_full">
            <table width="100%" class="table_form">
                ...
                <tr>
                    <th>ZTBCMS最低版本：</th>
                    <td>
                        <if condition=" $config['adaptation'] ">{$config.adaptation}
                            <else/>
                            <font color="#FF0000">没有标注，存在风险</font></if>
                        <if condition=" $version == false && isset($version) "><br/><font color="#FF0000">该模板最低只支持ZTBCMS
                                {$config.adaptation} 版本，请升级后再安装，避免不必要是损失！</font></if>
                    </td>
                </tr>
        ...
        <div class="">
            <div class="btn_wrap_pd">
                ...
                <input type="hidden" name="is_tp6" value="<?= !empty($config['is_tp6']) ? 1 : 0; ?>">
