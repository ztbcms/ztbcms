...
<div class="wrap">
  ...
  <table width="100%" height="100%" style="table-layout:fixed;">
    ...
    <tr class="tab">
      <th> <div class="search">
          <input size="15" placeholder="请输入搜索内容" id="J_search_keyword" type="text">
        ...
        for (var attr in data) {
            if (data[attr] && typeof (data[attr]) === 'object') {
                ...
                if (attr === 'name') {
                    ...
                    if (!(data['isChild'])) {
                        //一级菜单
                        html.push('<dt><a href="' + data.url + '" data-id="' + data.id + '"><b><i class="iconfont icon-yuandianxuhao" style="font-size: 12px;margin-right: 4px;"></i>' + data.name + '</b></a></dt>');
                    } else {
                        //二级菜单
