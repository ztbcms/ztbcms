...
<head>
    ...
    <block name="header-main">
        ...
        <!--  Element UI START  -->
        <!-- 引入样式 -->
        <link rel="stylesheet" href="{$config_siteurl}statics/admin/theme/elementui/elementui_2.13.2/index.css">
        <!-- 引入组件库 -->
        <script src="{$config_siteurl}statics/admin/theme/elementui/elementui_2.13.2/index.js"></script>
        <!--  Element UI END  -->
